...
const testimonials = [
  {
    ...
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[0]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 1,
    testimonial: "I'm confident my data is safe with COMPANY. I can't say that about other providers.",
    by: "Dan, CTO at SecureNet",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[1]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 2,
    testimonial: "I know it's cliche, but we were lost before we found COMPANY. Can't thank you guys enough!",
    by: "Stephanie, COO at InnovateCo",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[2]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 3,
    testimonial: "COMPANY's products make planning for the future seamless. Can't recommend them enough!",
    by: "Marie, CFO at FuturePlanning",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[3]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 4,
    testimonial: "If I could give 11 stars, I'd give 12.",
    by: "Andre, Head of Design at CreativeSolutions",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[4]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 5,
    testimonial: "SO SO SO HAPPY WE FOUND YOU GUYS!!!! I'd bet you've saved me 100 hours so far.",
    by: "Jeremy, Product Manager at TimeWise",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[5]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 6,
    testimonial: "Took some convincing, but now that we're on COMPANY, we're never going back.",
    by: "Pam, Marketing Director at BrandBuilders",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[6]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 7,
    testimonial: "I would be lost without COMPANY's in-depth analytics. The ROI is EASILY 100X for us.",
    by: "Daniel, Data Scientist at AnalyticsPro",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[7]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 8,
    testimonial: "It's just the best. Period.",
    by: "Fernando, UX Designer at UserFirst",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[8]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 9,
    testimonial: "I switched 5 years ago and never looked back.",
    by: "Andy, DevOps Engineer at CloudMasters",
    imgSrc: `https://images.unsplash.com/photo-${unsplashIds[9]}?w=150&h=150&fit=crop`
  },
  {
    tempId: 10,
