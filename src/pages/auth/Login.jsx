...
const Login = () => {
  const { login, user, role, googleSignIn } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-10">
          ...
          <button
            ...
            className="w-full mt-6 bg-white border border-gray-200 text-charcoal rounded-lg py-3.5 font-bold hover:bg-gray-50 transition flex justify-center items-center gap-3 shadow-sm"
          >
